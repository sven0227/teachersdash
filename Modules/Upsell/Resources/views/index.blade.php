    ...
    $(document).ready(function() {
        $("#upsell_table").DataTable({
            ...
            columns: [
                ...
                {data: "price_items", name: "price_items", render: function(priceItems) {
                    var html = "<ul class='mb-0 pl-3'>";
                    if (priceItems.length) {
                        for(priceItem of priceItems) {
                            console.log(Object.keys(priceItem))
                            html += `<li><span style="display: inline-block; min-width: 20px">$${priceItem["price"]}</span> - ${priceItem.description}</li>`;
                        }
                    }
                    html += "</ul>"; 
                    return html;
                }},
                {data: "description", name: "description", render: function(description) {
