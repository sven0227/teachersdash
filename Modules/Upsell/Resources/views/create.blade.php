                    ...
                    <div class="row price-row">
                        <div class="col-md-3">
                            <div class="input-group">
                                <input type="number" class="form-control" name="price_items[0][price]"/>
                                <input type="text" placeholder="Description..." class="form-control" name="price_items[0][description]"/>
