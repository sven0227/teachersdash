                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" name="user_company_email" value="{{ $user->user_company_email ?? "" }}" placeholder="Company email"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">@lang('Company phone')</label>
                                                    <input type="text" class="form-control" name="user_company_phone" value="{{ $user->user_company_phone }}" placeholder="Company phone"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">@lang('Company website')</label>
                                                    <input type="text" class="form-control" name="user_company_website" value="{{ $user->user_company_website }}" placeholder="Company website"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
