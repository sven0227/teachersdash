                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        ...
                                        @endif
                                                ...
                                                <div class="form-group">
                                                    <label>Message:</label>
                                                    <textarea class="form-control" rows="15" name="description">{{ empty($template) ? '' : $template->description }}</textarea>
                                                </div>
                        ...
                        <div class="pt-3">
                            <div class="form-group d-flex">
                                ...
                                <div class="description pl-3 pt-2" style="flex: 1">
                                    <h3>SMS Service</h3>
                                    <h6>Amount: <b class="sms-amount">${{$sms_hire->amount}}</b></h6>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <select class="form-control" name="amount">
                                    @foreach ($sms_hires as $hire)
                                    <option value="{{ $hire->amount }}" {{$sms_hire->amount == $hire->amount ? 'selected' : ''}}>{{ $hire->amount }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <hr/>
                        <button class="btn btn-primary btn-block"><img src="{{url('img/mastercard.svg')}}" style="margin-right: 12px; height: 14px"/>Pay by credit card</button>
