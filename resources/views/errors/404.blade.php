        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    <h1 class="text-center">@lang('404 ERROR')</h1>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
  ...
  <!-- end of header -->
    <div class="ex-form-1 pt-5 pb-5" style="height: calc(100vh - 348px)">
        <div class="container">
            ...
            <p>{{__('Sorry but the page you are looking for does not exist, have been removed. name changed or is temporarily unavailable')}}</p>
